...
{
    public partial class FrmColumnAttribute : Form
    {
        ...
        public FrmColumnAttribute(string _jsontext)
        {
            InitializeComponent();
            jsonText = _jsontext;
        ...
        private void FrmPieAttribute_Load(object sender, EventArgs e)
        {
            ...
            txtKD.Text = columnInfo.YInterval.ToString();
            cbLengend.Checked = columnInfo.LengendShow;
            cbXY.Checked = columnInfo.XYShow;
