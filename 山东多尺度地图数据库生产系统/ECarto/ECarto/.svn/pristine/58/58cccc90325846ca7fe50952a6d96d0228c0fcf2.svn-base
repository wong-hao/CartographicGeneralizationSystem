...
{
    public partial class FrmPolyLinePropertySet : Form
    {
        ...
        public FrmPolyLinePropertySet(LabelJson json, IGroupElement groupEle_)
        {
            InitializeComponent();
            labelInfo = json;
            groupEle = groupEle_;
        ...
        private void View()
        {
            ...
            lbHelper.UpdatePolylineElement(this.TxtContent, this.TxtValueDown, center);
        }
