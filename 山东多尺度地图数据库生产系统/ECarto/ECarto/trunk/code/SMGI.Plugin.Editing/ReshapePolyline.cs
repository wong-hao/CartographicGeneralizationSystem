...
namespace SMGI.Plugin.GeneralEdit
{
    public class ReshapePolyline:SMGITool
    {
        ...
        {
            ReshapePolylineForm myResForm = new ReshapePolylineForm();
            myResForm.StartPosition = FormStartPosition.CenterScreen;
            myResForm.Show();
            myResForm.Visible = false;
            if (myResForm.ShowDialog() == DialogResult.OK) { panD = true; }
