...
{
    public partial class FrmAttriPropertySet : Form
    {
        ...
        public string TxtValueDown
        {
            get
            {
                string val = txtContentDown.Text.Trim();
                string[] strs = val.Split(new char[] { '\n', '\r' }, System.StringSplitOptions.RemoveEmptyEntries);
                if (strs.Length > 1)
                {
                    val = string.Empty;
        ...
        Font txtFontDown = new Font("宋体", 10);
        Color textColorDown = Color.Black;
        public FrmAttriPropertySet(LabelJson json, IGroupElement groupEle_)
        {
            InitializeComponent();
            labelInfo = json;
            groupEle = groupEle_;
        ...
        private void ConnectLineProperty()
        {
            ...
            for (int i = 0; i < groupEle.ElementCount; i++)
            {
                ...
                switch ((ee as IElementProperties).Name)
                {
                    ...
                    case "下标文本":
                        ...
                        this.txtContentDown.Text = txtElementDown.Text;
            ...
            double step = Math.Round((txtGeometry.Y - (geoPolygon as IArea).Centroid.Y) / GApplication.Application.ActiveView.FocusMap.ReferenceScale * 1000, 1);
            try
            {
                this.numericUpDownTxt.Value = (decimal)step;
            }
            catch
            {
            }
        ...
        {   
            ...
            try
            {
                ...
                FontStyle fs = LabelClass.Instance.GetFontStlye(txtElement);
                ...
                //下标
                lbFontDown.Text = txtFontDown.Name + "," + txtFontDown.Size + "pt";
                lbColorDown.ForeColor = textColorDown;
                lbColorDown.Text = textColorDown.Name;
                if(txtElementDown!=null)
                {
                    fontname = (txtElementDown as ISymbolCollectionElement).FontName;
                    fontsize = (float)(txtElementDown as ISymbolCollectionElement).Size;
                    fs = LabelClass.Instance.GetFontStlye(txtElementDown);
                    txtFontDown = new System.Drawing.Font(fontname, fontsize,fs);
                    lbFontDown.Text = fontname + "," + fontsize + "pt";
                    textColorDown = ColorHelper.ConvertIColorToColor(txtElementDown.Symbol.Color);
                    lbColorDown.ForeColor = textColorDown;
                    lbColorDown.Text = textColorDown.Name;
                }
        ...
        private void btAdv_Click(object sender, EventArgs e)
        {
            ...
            if (expand)
            {
                this.Height -= (panelLine.Height + panelBackGround.Height + panelAnthor.Height);
            }
            else
            {
                this.Height += (panelLine.Height + panelBackGround.Height + panelAnthor.Height);
        ...
        private void UpdateParms()
        {
            ...
            ele.Element("Font").SetValue(this.numericUpDownTxt.Value);
            ele = root.Element("TextDown");
            ele.Element("Font").Attribute("FontName").SetValue(txtFontDown.Name);
            ele.Element("Font").Attribute("FontSize").SetValue(txtFontDown.Size);
            ...
            ele.Element("Font").Attribute("FontItalic").SetValue(txtFontDown.Italic);
            ele.Element("Font").Attribute("FontBold").SetValue(txtFontDown.Bold);
            ele.Element("Font").SetValue(this.numericUpDownTxt.Value);
            //背景框
            ...
            ele.Element("FillStlye").Value = "实心";
            //连接线
        ...
        private void View()
        {
            ...
            lbHelper.UpdateAttributeElement(this.TxtContent, this.TxtValueDown, center);
        }
        ...
        private void btfontColorDown_Click(object sender, System.EventArgs e)
        {
        ...
        private void btFontDown_Click(object sender, System.EventArgs e)
        {
             FontDialog pFontDialog = new FontDialog();
             pFontDialog.Font = txtFontDown;
            if (pFontDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                lbFontDown.Text = pFontDialog.Font.Name + "," + pFontDialog.Font.Size + "pt";
                txtFontDown = pFontDialog.Font;
                lbFontDown.Font = txtFontDown;
            }
        }
