...
namespace SMGI.Plugin.EmergencyMap
{
    ...
    public sealed class LabelPolyLineTool :SMGITool
    {

        public LabelPolyLineTool()
        {
        ...
        public override void OnClick()
        {
            ...
            FrmPolyLineSet frm = new FrmPolyLineSet();
            if (DialogResult.OK == frm.ShowDialog())
            {
                text = frm.TxtValue;
                text1 = frm.TxtValueDown;
                isCheck = true;
            }
        }
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            ...
            LabelClass.Instance.CreateLabelPolyLine(text,text1, pp);
            isDraw = true;
        }
