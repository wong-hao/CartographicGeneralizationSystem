...
{
    //多系列
    public class ColumnCubeCommand :SMGITool
    {
        private IActiveView pAc;
      
        private double mapScale;
        public ColumnCubeCommand()
        {
        }
        ...
        public override void OnMouseDown(int button, int shift, int x, int y)
        {
            ...
            DrawCubeColumn column = new DrawCubeColumn(pAc, mapScale);
            column.CreateCubeColumns(anchorPoint);
