...
namespace DatabaseUpdate
{
    ...
    public sealed class RoadStrokeTool : BaseTool
    {
        ...
        public RoadStrokeTool()
        {
            ...
            base.m_name = "DatabaseUpdate.RoadStrokeTool";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
            try
            {
                //
        ...
        public override void OnCreate(object hook)
        {
            ...
            if (hook is IMxApplication&&roadlayers!=null)
                base.m_enabled = true;
            else
